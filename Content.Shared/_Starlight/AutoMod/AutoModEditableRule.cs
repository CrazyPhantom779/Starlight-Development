...
public sealed class AutoModEditableRule
{
    ...
    public List<AutoModEditableLevel> Levels { get; set; } = [];
    ...
    => new()
    {
        ...
        Levels = [.. Levels.Select(x => x.Clone())],
        Source = Source,
    };
}
...
public sealed class AutoModEditableAdminPolicy
{
    ...
    public AutoModEditableAdminPolicy Clone() => new()
    {
...
public sealed class AutoModEditableMatch
{
    ...
    public string? WordSet { get; set; } // Intentionally ignored. Kept for wire compatibility with older branch data.
    ...
    public AutoModEditableMatch Clone() => new()
    {
        Kind = Kind,
        WordSet = WordSet,
        Pattern = Pattern,
...
public sealed class AutoModEditableEvidence
{
    ...
    public AutoModEditableEvidence Clone() => new()
    {
        Mode = Mode,
...
public sealed class AutoModEditableEscalation
{
    ...
    public AutoModEditableEscalation Clone() => new()
    {
        Scope = Scope,
        ScopeKey = ScopeKey,
...
public sealed class AutoModEditableDiscord
{
    ...
    public AutoModEditableDiscord Clone() => new()
    {
        LogMode = LogMode,
...
public sealed class AutoModEditableLevel
{
    ...
    public AutoModEditableLevel Clone() => new()
    {
        MinPoints = MinPoints,
...
public sealed class AutoModEditableApproval
{
    ...
    public AutoModEditableApproval Clone() => new()
    {
        Timeout = Timeout,
...
public sealed class AutoModEditableAction
{
    ...
    public AutoModEditableAction Clone() => new()
    {
        Type = Type,
        Message = Message,
        Reason = Reason,
