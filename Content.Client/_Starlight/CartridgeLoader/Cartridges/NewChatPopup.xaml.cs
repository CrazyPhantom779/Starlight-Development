...
public sealed partial class NewChatPopup : DefaultWindow
{
    ...
    public NewChatPopup()
    {
        ...
        {
            if (args.Text.Length > SharedNanoChatSystem.MaxFullNameLength)
                NameInput.Text = args.Text[..SharedNanoChatSystem.MaxFullNameLength];
            ValidateInputs();
        };

        JobInput.OnTextChanged += args =>
        {
            if (args.Text.Length > SharedNanoChatSystem.MaxJobTitleLength)
                JobInput.Text = args.Text[..SharedNanoChatSystem.MaxJobTitleLength];
        };
    }
